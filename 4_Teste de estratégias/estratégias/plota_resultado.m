...
le_base_ativo = load("Novos dados\bpsc\q0p2000\ativo\base.mat", "base");
base_ativo = le_base_ativo.base;

le_stgy_ativo = load("Novos dados\bpsc\q0p2000\ativo\stgy.mat", "stgy");
stgy_ativo = le_stgy_ativo.stgy;

amplitude_stgy_ativo = stgy_ativo(:,2);
amplitude_base_ativo = base_ativo(:,2);

le_base_reativo = load("Novos dados\bpsc\q0p2000\reativo\base.mat", "base");
base_reativo = le_base_reativo.base;

le_stgy_reativo = load("Novos dados\bpsc\q0p2000\reativo\stgy.mat", "stgy");
