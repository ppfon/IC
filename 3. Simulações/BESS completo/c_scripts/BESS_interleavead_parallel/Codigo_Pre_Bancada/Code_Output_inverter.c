...
if(count == PRD)
{
  ...
  if(control_enable == 1)
  {
    ...
    //PRf_alfa.Xref = (PLL.Valfa_in*(P_control) )/((PLL.Valfa_in*PLL.Valfa_in + PLL.Vbeta_in*PLL.Vbeta_in + 1e-2)*(PLL.Valfa_in*PLL.Valfa_in + PLL.Vbeta_in*PLL.Vbeta_in + 1e-2));
    //PRf_beta.Xref = (Q_control*PLL.Valfa_in)/((PLL.Valfa_in*PLL.Valfa_in + PLL.Vbeta_in*PLL.Vbeta_in + 1e-2)*(PLL.Valfa_in*PLL.Valfa_in + PLL.Vbeta_in*PLL.Vbeta_in + 1e-2));
    ...
    */
    ...
    // IMPLENTAÇÃO CONTROLE AARC - Controle Ativo e Reativo Médio
    ...
    */
    ...
    // IMPLENTAÇÃO CONTROLE BPSC - Controle de Sequência-Positiva Balanceada
    ...
    */
    ...
    // IMPLENTAÇÃO CONTROLE PNSC - Controle de Sequência Negativa e Positiva
